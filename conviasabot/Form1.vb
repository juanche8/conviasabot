...
Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim content As String = reader.ReadToEnd()
        reader.Close()
        Dim fecha1 =vbTab+vbTab+vbTab+ """B_DATE_1"": """  + Format(DateEdit1.DateTime, "yyyyMMdd1200")+""""+","
        Dim fecha2 =vbTab+vbTab+vbTab+ """B_DATE_2"": """  + Format(DateEdit2.DateTime, "yyyyMMdd0000")+""""+","
        Dim fecha3 =vbTab+vbTab+vbTab+ """fecha_desde"": """  +DateEdit1.Text+""""+","
        Dim fecha4 =vbTab+vbTab+vbTab+ """fecha_hasta"": """  +DateEdit2.text+""""+","
        Dim lineas() As String = File.ReadAllLines("C:\Users\juanyoris\Documents\GitHub\conviasa-bot\config2.js")

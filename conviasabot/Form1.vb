...
Public Class Form1
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TabNavigationPage3.PageText = "Consultar!"
    End Sub
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim reader As New StreamReader("C:\Program Files (x86)\conviasa\config.js") 'directorio de prueba. podra ser un reader global.
        Dim content As String = reader.ReadToEnd()
        reader.Close()
               Dim replacetext = vbTab & vbtab & "to: '" & mailbox.Text & "',"
        dim primero = content.substring(191)
        Dim lineas() As String = File.ReadAllLines("C:\Program Files (x86)\conviasa\config.js")
                content = Regex.Replace(content, lineas(6), replacetext)
               Dim writer As New StreamWriter("C:\Program Files (x86)\conviasa\config.js")
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim reader As New StreamReader("C:\Program Files (x86)\conviasa\config.js")
        Dim content As String = reader.ReadToEnd()
        reader.Close()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        System.Diagnostics.Process.Start("C:\Program Files (x86)\conviasa\run.bat")
    End Sub
End Class
